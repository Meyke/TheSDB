...
class BasicBufferMgr {
	...
	private ChooseUnpinnedBufferStrategy unpinnedStrategy;
	...
	synchronized Buffer pin(Block blk) {
		...
		if (buff == null) {
			buff = this.unpinnedStrategy.chooseUnpinnedBuffer();
			if (buff == null)
				return null;
	...
	synchronized Buffer pinNew(String filename, PageFormatter fmtr) {
		Buffer buff = this.unpinnedStrategy.chooseUnpinnedBuffer();
		if (buff == null)
			return null;
